...
(HGKM-DEF-FUN HGKM-ICOPEN (FNAME)
 (PROG (CHANNEL)
  (SETQ CHANNEL
   (OPEN (STRING FNAME) :DIRECTION :INPUT
               :IF-DOES-NOT-EXIST NIL))
  (COND 
   ((NULL CHANNEL) (HGKM-ABORT 'NO-SUCH-FILE)) 
   (T (PROGN
...
(HGKM-DEF-FUN HGKM-OSOPEN (FNAME)
 (PROG (CHANNEL)
  (SETQ CHANNEL
   (OPEN (STRING FNAME) :DIRECTION :OUTPUT
...
(HGKM-DEF-FUN CHAN-CHI (CHAN)
 (LET ((CH (READ-CHAR CHAN NIL $HGKM-EOF$)))
  (IF (EQ CH $HGKM-EOF$) (HGKM-ABORT $HGKM-EOF$) (CHAR-CODE CH))))
...
(HGKM-DEF-FUN CHAN-CHO (CHAR CHAN) (WRITE-CHAR (CODE-CHAR CHAR) CHAN))
...
(HGKM-DEF-FUN HGKM-CHO (CH) (WRITE-CHAR (CODE-CHAR CH) SELECTED-OUTPUT))
