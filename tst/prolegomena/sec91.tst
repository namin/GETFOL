...
MATTACH - dar [FUNCONST] OBJ::FUNCONST:-;
DEFLAM fun1apply (FUNCONST TERM1) (appl\-mak FUNCONST (LIST TERM1));
ATTACH fun1apply TO [FUNCONST,TERM=TERM] fun1apply;
DEFLAM fun2apply (FUNCONST TERM1 TERM2) (appl\-mak FUNCONST (LIST TERM1 TERM2));
